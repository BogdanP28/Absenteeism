...
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        # concatenate df and the 4 types for reason for absence
    ...
    def predicted_probability(self):
        ...
        if (self.data is not None):
            pred = self.reg.predict_proba(self.data)[:,1] # Take only last column, prob of being 1
    ...
    def predicted_outputs(self):
        '''predict the outputs and the probabilities
